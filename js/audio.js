function audiojs(){
  window.PlaySound = function(act){
    ...
    if(act == 'gitar' && !dancer && is.chrome() ){ // эта вся фигня работает только в хроме
      ...
      var sounds = (function(){ var arr = ['hurry', 'youhowme','fellinlove']; return arr[ Math.floor(Math.random()*arr.length) ]  })();
