function actionjs(){
  ...
  window.ChangeMe = function(options , sketch, act){
    nextActionSeeAll();
  ...
  window.shakeCanvas = function(time, dur, range){
    var t = 0;
    var rang = range || 12;
  ...
  window.movearound = function(delay){ /// охуенная штука - всё летает по кругу
    var tm = 0;
    var inter = setInterval(function(){
  ...
  window.changeBackground = function(time, dur,smooth, callback){ // ну тут понятно - меняется фон
    var t = 0;
    var val = 0;
    function genc(){
