function canhelpjs(){
  ...
  window.nextActionSeeAll = function(){
  ...
  window.findNear = function(object , mindist){  // instead of try containsPoint(e, target) click group findTarget(e, skipGroup)
    var l = object.left;
    var t = object.top;
  ...
  window.makeHandler = function(opt , arg, duration , owner) {
    if(owner){
